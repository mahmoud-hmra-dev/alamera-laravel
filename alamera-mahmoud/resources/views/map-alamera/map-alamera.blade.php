...
<script>
    ...
    console.log( ac.product_desc)
     ...
     x = ac.product_qty;
      ...
      var toInsert = '<<rect x=' + ac.product_qty + ' y=' + ac.product_desc +'  fill="green"  width="5" height="5"/>'
...
<script>
    const urllaboratory = "http://127.0.0.1:8000/api/cru"
