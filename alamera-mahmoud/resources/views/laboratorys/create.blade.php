...
<body>
    ...
    <div class="row">
        ...
        <div class="col-lg-12 text-center" style="margin-top:10px;margin-bottom: 10px;">
            <a class="btn btn-primary" href="{{ route('laboratorys.index') }}"> Back</a>
        </div>
    </div>
    
    
    <form style="display: none" action="{{ route('laboratorys.store') }}" method="POST">
        @csrf
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <textarea id="x-laboratory" class="form-control" style="height:150px" name="product_desc" placeholder="Product Description"></textarea>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
             
                    <input id="y-laboratory" type="text" class="form-control" name="product_qty" >
                </div>
            </div>
    ...
    <script>
        ...
        document.getElementById("x-laboratory").value = coords.y
        document.getElementById("y-laboratory").value = coords.x
     ...
     setTimeout(function() {
            // Get the data
            $.getJSON("http://127.0.0.1:8000/api/laboratory", function(data) {
                // Success
